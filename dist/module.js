define(["app/core/core_module","app/plugins/sdk"], function(__WEBPACK_EXTERNAL_MODULE_8__, __WEBPACK_EXTERNAL_MODULE_4__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
var _core_module = __webpack_require__(8);
...
var Hello = function (_PureComponent) {
    ...
    function Hello() {
        ...
        var _this = _possibleConstructorReturn(this, (_ref = Hello.__proto__ || Object.getPrototypeOf(Hello)).call.apply(_ref, [this].concat(args)));

        _this.handleTitleChange = function (e) {
            var value = e.target.value;

            _this.props.onChangeTitle({ value: value });
        };
...
_core_module2.default.directive("reactDirective", function () {
    return {
        scope: {
            color: '=',
            title: '=',
        ...
        link: function link($scope, el, attrs) {
            ...
            $scope.$watchGroup(['color', 'title', 'onChangeTitle'], function () /* newValue, oldValue */{
                _reactDom2.default.render(_react2.default.createElement(Hello, {
...
var Ctrl = function (_PanelCtrl) {
    ...
    function Ctrl($scope, $injector) {
        ...
        var _this2 = _possibleConstructorReturn(this, (Ctrl.__proto__ || Object.getPrototypeOf(Ctrl)).call(this, $scope, $injector));

        _.defaultsDeep(_this2.panel, panelDefaults);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};if(true){(function(){'use strict';var React=__webpack_require__(0);var _assign=__webpack_require__(1);var checkPropTypes=__webpack_require__(2);var scheduler=__webpack_require__(13);var tracing=__webpack_require__(15);/**
 * Use invariant() to assert state which your program assumes to be true.
 *
 * Provide sprintf-style format (only %s is supported) and arguments
 * to provide information about what broke and what you were
